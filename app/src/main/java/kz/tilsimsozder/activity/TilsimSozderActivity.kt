package kz.tilsimsozder.activity
...
import kotlinx.android.synthetic.main.activity_tilsim_sozder.*
...
class TilsimSozderActivity : Activity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_tilsim_sozder)
    ...
    private fun setupAdapter() {
        val adapter = CustomListAdapter(this@TilsimSozderActivity, R.layout.custom_list, LIST_TITLE_DATA.toTypedArray())
    ...
    private fun getJSONData() {
        ...
        LIST_TITLE_DATA = this.resources.getStringArray(R.array.tilsim_sozder_title).toMutableList()
        LIST_CONTENT_DATA = this.resources.getStringArray(R.array.tilsim_sozder_content).toMutableList()
