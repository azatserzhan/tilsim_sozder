...
class PrayersActivity : Activity() {
    ...
    private fun setupAdapter() {
        val adapter = CustomListAdapter(this@PrayersActivity, R.layout.custom_list, LIST_TITLE_DATA.toTypedArray())
    ...
    private fun listClickAction() {
        listViewMainScreen.onItemClickListener = AdapterView.OnItemClickListener { _, view, position, id ->
    ...
    private fun getJSONData() {
        ...
        LIST_TITLE_DATA = this.resources.getStringArray(R.array.prayer_name).toMutableList()
